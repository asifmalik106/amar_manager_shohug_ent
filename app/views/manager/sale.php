<body>
    ...
    <div id="page-wrapper">
        ...
        <!-- /.row -->
        <div class="row">
            <form method="POST" action="<?php echo BASE_URL; ?>manager/sale/add/">
                <div class="col-md-9">
...
<p>Date: <input type="text" name="date" id="datepicker" required="1" value="<?php echo date('Y-m-d'); ?>" readonly> Today is: <?php date_default_timezone_set($_SESSION['data']['businessTimeZone']); echo "<b>".date('yy-m-d')."</b> Now: <b>".date('h:m:s A')."</b>"; ?></p>
