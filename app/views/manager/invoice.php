<body >
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <a href="<?php echo BASE_URL.'manager/invoice/print/'.$data['data']['invID']; ?>" target="_blank" class="btn btn-primary btn-lg">Print Invoice</a>
                <table class="invoice-md">
                    <tr>
                        <td> <strong>Name: </strong> </td>
                      <td> <a href="<?php echo BASE_URL."manager/".$sctype."/".$data['data']['info']['scID']; ?>"> <?php echo $data['data']['info']['scNameCompany'];?></a> </td>
                    </tr>
                    <tr>
