          ...
          <table class="table">
            ...
            <tr>
              ...
              <td>
                ...
                <h2 id="payInvoiceDue" class="delete"></h2>
              </td>
            </tr>
          </table>
              ...
              <?php date_default_timezone_set($_SESSION['data']['businessTimeZone']); ?>
              <p>Date: <input type="text" id="datepicker" value="<?php echo date('yy-m-d'); ?>" required readonly> Today is: <?php echo "<b>".date('yy-m-d')."</b> Now: <b>".date('h:m:s A')."</b>"; ?></p>
            </div>
            <div class="form-group">
              <label><?php echo $profileLang['payDueAmount']; ?></label>
