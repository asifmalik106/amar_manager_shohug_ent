...
<div id="page-wrapper">
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Expense Category</h3>
        </div>
    </div>
	<div class="row">
		<div class="col-lg-8">
		<form class="form-inline">
			<div class="form-group">
				<input class="form-control" placeholder="Search Expense Category..." id="searchCategory" oninput="searchCat()">
			</div>
			<div class="form-group" style="display: none;" id="loadingExpenseCategory">
    			<div class="form-control loadingCategoryStyle">
    			<p><img src="<?php echo BASE_URL; ?>asset/reload.gif"> Loading</p>
    			</div>
  			</div>	
			<div class="form-group">
				<button type="button" class="reloadCategory btn btn-primary pull-right reloadCategory" onclick="loadExpenseCategory()"><i class="glyphicon glyphicon-refresh"></i></button>
			</div>
		</form>
			...
			<table id="categoryTable" class="table table-striped table-bordered">
				<thead>
					<tr>
						<th width="20%">Expense Category ID</th>
						<th>Expense Category Name</th>
						<!--<th>Action</th>-->
					</tr>
				</thead>
				<tbody id="loadExpenseCategory">
		...
		<div class="col-lg-4">
			<div class="catStatusHeight">
				<div id="expenseCategoryStatusTrue" style="display: none">
					<div class="alert alert-success alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	  				<strong><i class="glyphicon glyphicon-ok"></i> Expense Category Added Successfully!</strong> 
					</div>
				</div>
				<div id="expenseCategoryStatusFalse" style="display: none">
					<div class="alert alert-danger alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	  				<strong><i class="glyphicon glyphicon-remove"></i> Failed to Add Expense Category!</strong> 
					</div>
				</div>
				<div id="expenseCategoryStatusEmpty" style="display: none">
					<div class="alert alert-warning alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	  				<strong><i class="glyphicon glyphicon-info-sign"></i> Expense Category Name Required...</strong> 
					</div>
				</div>
				<div id="expenseCategoryStatusDuplicate" style="display: none">
					<div class="alert alert-warning alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	  				<strong><i class="glyphicon glyphicon-warning-sign"></i> Expense Category Already Exists!!!</strong> 
					</div>
				</div>
				<div id="expenseCategoryStatusLoading" style="display: none">
					<div class="alert" role="alert">
	  				<strong><img src="<?php echo BASE_URL; ?>asset/reload.gif">  Please Wait..</strong> 
					</div>
				</div>
				...
				<div class="panel panel-primary">
					<div class="panel-heading"><h4 align="center"><b>Add New Expense Category</b></h4></div>
					<div class="panel-body">
						<form>
							<div class="form-group">
								<label>Expense Category Name</label>
								<input type="text" class="form-control" id="newExpenseCategoryName">
							</div>
						</form>
					</div>
					<div class="panel-footer">
						<button type="button" class="btn btn-primary" onclick="addExpenseCategory()">Add Expense Category</button>
					</div>
				</div>
			</div>
		</div>
